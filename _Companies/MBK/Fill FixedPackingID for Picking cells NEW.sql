...
exec master..xp_cmdshell 'bcp WMS_MBK.dbo.__Buffer in "E:\MBK_Picking_Fixed_NEW.txt" -c -k -C1251 -T';
...
SELECT * from __Buffer where CellID is Null or PackingID is Null
RETURN
